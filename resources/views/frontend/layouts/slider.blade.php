            ...
            <div class="col-md-12 col-sm-12">
                <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
                    <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                        <ul>
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img1.jpg'><img src='http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img1.jpg' alt="slide-img" data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                <div class="info">
                                    <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500' data-speed='500' data-start='80' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:2;white-space:nowrap;'><span>Modern Design</span> </div>
                            ...
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img2.jpg'><img src='http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img2.jpg' alt="slide-img" data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                <div class="info">
